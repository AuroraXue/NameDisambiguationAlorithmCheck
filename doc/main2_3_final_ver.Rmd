---
title: Project 4 - Name disambiguation in author citations using Spectral clustering
  & EM algorithm with C6 tau-coauthor constraints
output:
...
```{r read and preprocess data,eval=F,echo=F}
...
```{r apply_spec_cluster,eval=F,echo=F}
